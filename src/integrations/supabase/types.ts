...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      award_upload_points: { Args: { p_clip_id: string }; Returns: undefined }
      has_role: {
        Args: {
      ...
      notify_comment: {
        Args: { p_clip_id: string; p_commenter_username: string }
        Returns: undefined
      }
      redeem_reward_atomic: { Args: { p_reward_id: string }; Returns: Json }
      toggle_clip_like: {
